#!/usr/bin/env python
# template taken from Dan Blankenberg
...
def _makeblastdb(fasta_filename, out_file):
    os.system('makeblastdb -in ' + fasta_filename + ' -dbtype \'nucl\' -out ' + out_file)
    return (out_file)
...
def add_blastdb_to_table(data_manager_dict, fasta_readers, target_directory, dbkey, dbkey_name, sequence_id, sequence_name, params, **kwds):
...
FILE_FORMAT = dict(fasta='',blastdb='')
